...
RSpec.feature 'Logins', type: :feature do
  ...
  scenario "When click on user Should redirected to that user's show page" do
    ...
    @user2 = User.create(name: 'Paka', email: 'paka@gmail.com', password: 'azerty', confirmed_at: Time.now, photo: "http://www.pselaw.com/wp-content/uploads/2016/08/pokemon-150x150.jpg")
  ...
  scenario "can see a button that lets me view all of a user's posts." do
    @user1 = User.create(name: 'Yannick', email: 'akabrouyannickn@gmail.com', password: 'azerty', confirmed_at: Time.now, photo: "http://www.pselaw.com/wp-content/uploads/2016/08/pokemon-150x150.jpg", bio: "I'm a good person")
    @user2 = User.create(name: 'Julie', email: 'julie@gmail.com', password: 'azerty', confirmed_at: Time.now, photo: "http://www.pselaw.com/wp-content/uploads/2016/08/pokemon-150x150.jpg", bio: "Software engineer")
